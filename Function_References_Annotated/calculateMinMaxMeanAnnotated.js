...
a JavaScript object that contains the data of the minimum value,
the maximum value, and the mean (average) value from the provided array.
The provided array must contain integers only.
*/
